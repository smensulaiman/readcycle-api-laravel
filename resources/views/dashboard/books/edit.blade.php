                    ...
                    <form method="POST" action="{{ route('dashboard.books.update', $book) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      name="description" 
                                      rows="4" 
                                      placeholder="Tell us about this book...">{{ old('description', $book->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <!-- File Upload Option -->
                            <div class="mb-3">
                                <label for="photo" class="form-label">Upload New Image File</label>
                                <input type="file" 
                                       class="form-control @error('photo') is-invalid @enderror" 
                                       id="photo" 
                                       name="photo" 
                                       accept="image/*">
                                <div class="form-text">Upload a new cover image for your book (JPG, PNG, GIF - Max 2MB)</div>
                                @error('photo')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <!-- URL Option -->
                            <div class="mb-3">
                                <label for="photo_url" class="form-label">New Image URL</label>
                                <input type="url" 
                                ...
                                <div class="form-text">Enter a URL to a new image (JPG, PNG, GIF)</div>
                                @error('photo_url')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('dashboard.books.show', $book) }}" class="btn btn-outline">
